...
namespace sjsu::arm
{
    ...
    const char kGETRequestFormat[] = "arm?heartbeat_count=%d&is_operational=%d&speed=%d&joint_mode=%c&rotunda_angle=%d&shoulder_angle=%d&elbow_angle=%d&wrist_pitch_angle=%d&wrist_roll_angle=%d&hand_mode=%c&pinky_angle=%d&ring_angle=%d&middle_angle=%d&index_angle=%d&thumb_angle=%d";
    ...
    struct arm_arguments
    {
        ...
        void Print()
        {
            printf(kResponseBodyFormat, joint_args.heartbeat_count, joint_args.is_operational, joint_args.speed, joint_args.mode, joint_args.rotunda_angle, joint_args.shoulder_angle, joint_args.elbow_angle, joint_args.wrist_pitch_angle, joint_args.wrist_roll_angle, hand_args.mode, hand_args.pinky_angle, hand_args.ring_angle, hand_args.middle_angle, hand_args.index_angle, hand_args.thumb_angle);
        }
    };
}