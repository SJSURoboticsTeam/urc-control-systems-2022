...
namespace sjsu::arm
{
    TEST_CASE("Mission Control Testing")
    {
        ...
        SECTION("should return default arm status on startup")
        {
            ...
            "?heartbeat_count=0&is_operational=0&arm_mode=A&hand_mode=A&arm_speed="
            ...
            "pointer_angle=0&thumb_angle=0&pinky_angle=0&ring_angle=0&middle_angle=0"
            "index_angle=0&thumb_angle=0&rountda_accel_x=0&rountda_accel_y=0&rountda_accel_z=0"
