...
void InitializeBase(sjsu::Mpu6050 &rotunda, sjsu::Mpu6050 &shoulder, sjsu::lpc40xx::I2c &i2c)
{
    uint8_t buff[1] = {0};
    buff[0] = 1 ;
...
void InitializeJoints(sjsu::Mpu6050 &elbow, sjsu::Mpu6050 &wrist, sjsu::lpc40xx::I2c &i2c)
{
    wrist.Initialize();
