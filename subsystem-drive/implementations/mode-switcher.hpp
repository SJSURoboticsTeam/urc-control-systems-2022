...
namespace sjsu::drive
{
    ...
    public:
        ...
        {
            bool hubs_stopped((previous_arguments.left.hub.speed >= static_cast<float>(-0.01) && previous_arguments.left.hub.speed <= static_cast<float>(0.01)) && (previous_arguments.right.hub.speed >= static_cast<float>(-0.01) && previous_arguments.right.hub.speed <= static_cast<float>(0.01)) && (previous_arguments.back.hub.speed >= static_cast<float>(-0.01) && previous_arguments.back.hub.speed <= static_cast<float>(0.01)));
